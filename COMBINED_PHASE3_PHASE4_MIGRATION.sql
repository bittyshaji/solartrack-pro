...
-- All Contractor Requirement Modules
-- Generated: April 17, 2026
-- 
-- IMPORTANT: Run this against your Supabase PostgreSQL database
...
-- ============================================================
-- 2. FOLLOWUP TRACKER (Contractor #4)
-- ============================================================
...
CREATE POLICY "Users can view followups for their projects"
  ...
  USING (
    project_id IN (
      SELECT id FROM projects WHERE auth.uid() = user_id OR auth.uid() IN (
...
-- ============================================================
-- 3. PROJECT SECURE STATUS (Contractor #5)
-- ============================================================
...
-- ============================================================
-- 4. KSEB FEASIBILITY SUBMISSION (Contractor #6)
-- ============================================================
...
CREATE POLICY "Users can view their own organization's submissions" ON kseb_feasibility_submissions
  FOR SELECT USING (
    EXISTS (
...
CREATE POLICY "Users can insert submissions for their organization" ON kseb_feasibility_submissions
...
-- ============================================================
-- 5. STAGE CHECKLISTS & METRICS (Contractor #8)
-- ============================================================
-- ============================================================
...
-- ============================================================
-- 6. STAFF ATTENDANCE & WAGE PAYMENT (Contractor #9)
-- ============================================================
-- Staff Members Table
...
-- ============================================================
-- 7. COMPLETION CERTIFICATES (Contractor #11)
-- ============================================================
...
-- ============================================================
-- 8. KSEB ENERGISATION (Contractor #12)
-- ============================================================
...
-- ============================================================
-- 9. PAYMENT WORKFLOW (Contractor #14, #16)
-- ============================================================
...
-- ============================================================
-- 10. HANDOVER DOCUMENTS (Contractor #15)
-- ============================================================
...
CREATE POLICY "Users can view handover documents for their own projects" ON handover_documents
  ...
  USING (
    project_id IN (
      ...
      WHERE p.user_id = auth.uid() OR p.company_id IN (
...
-- ============================================================
-- 11. WARRANTY MANAGEMENT (Contractor #17)
-- ============================================================
...
-- ============================================================
-- 12. SERVICE REQUESTS (Contractor #18)
-- ============================================================
-- ============================================================
